...
const verifyAdminTokenMiddleware = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { verificationToken } = req.body;
    if (!verificationToken) {
        return res.status(400).json({ message: "Verification token is required" });
    }
    try {
        const decoded = (0, token_service_1.generateAdminVerificationToken)(verificationToken);
